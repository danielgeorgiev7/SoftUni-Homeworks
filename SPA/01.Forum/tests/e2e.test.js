...
const host = 'http://127.0.0.1:5500/01.Forum'; // Application host (NOT service host - that can be anything)
const interval = 300;
const DEBUG = false;
const slowMo = 500;
  ...
  describe('Forum', () => {
    ...
    it('Check is comment field is available', async () => {
      ...
      await page.click(
       ...
       console.log(await page.isVisible('.answer-comment textarea'))
    ...
    it('Check cancel button', async () => {
      ...
      console.log('>>' + await form[0]);
      console.log('>>' + await form[1]);
